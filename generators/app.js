...
module.exports = function(gulp, common, modules) {
  ...
  gulp.task('default', function (done) {
    var prompts = [{
      ...
      name: 'appDescription',
      message: 'What is the description or your project?',
      ...
      name: 'xquerrailApplicationName',
      message: 'What is XQuerrail application name?',
      default: 'app',
    ...
    modules.inquirer.prompt(prompts,
      function (answers) {
        ...
        answers.xquerrail = {};
        answers.xquerrail.name = answers.xquerrailApplicationName;
        // delete answers.xquerrailApplicationName;
        answers.xquerrail.user = answers.appNameSlug + '-user';
